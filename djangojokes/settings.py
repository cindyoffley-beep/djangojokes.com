...
SECRET_KEY = 'django-insecure-+w^&2v*iyv8g2kxx+#&k!rqazbw79@yzjd9t%-#$o1dwa0l5a8'
...
DEFAULT_FROM_EMAIL = 'coffley@comcast.net'
...
# Static files and media files on AWS S3

AWS_ACCESS_KEY_ID = os.environ.get('AWS_ACCESS_KEY_ID')
AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_SECRET_ACCESS_KEY')

AWS_STORAGE_BUCKET_NAME = 'django-jokes-cindy-offley-2026'
